...
function tablecontrato(){
        $('#tablecontrato').dataTable().fnClearTable();
        $('#tablecontrato').dataTable().fnDestroy();
                    
                    
    tableR = $('#tablecontrato').dataTable({
            ...
            //"sAjaxDataProp": "demo",
    "ajax":{
                     url :"crearcontrato", // json datasource
                     type: "post",  // method  , by default get
                     data: {"func" : "tablecontrato"},
