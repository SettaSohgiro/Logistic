...
<html>
    <head>
        ...
        <title>Portal Productor</title>
        <jsp:include page="/views/menu/cabemenu.jsp"/>
        <script type="text/javascript" src="https://code.jquery.com/jquery-3.5.1.js"></script>
        <script type="text/javascript" src="${pageContext.request.contextPath}/views/productor/productor2.js"></script>
                    ...
                    <div class="col">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <jsp:include page="views/productor/productor_nab_tab.jsp" />
                            </div>
                        </div>
                    </div>
                </div>
    ...
    <jsp:include page="/productomodal.jsp"/>
</body>
</html>
