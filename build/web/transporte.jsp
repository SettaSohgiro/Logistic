...
<html>
    <head>
        ...
        <link href="https://cdn.datatables.net/1.11.3/css/jquery.dataTables.min.css" rel="stylesheet">
          ...
          <script type="text/javascript" src="${pageContext.request.contextPath}/views/transporte/transporte.js"></script>
        ...
        <div class="col">
          <div class="card">
            <div class="card-body">
              ...
              <jsp:include page="views/transporte/contenttransporte.jsp" />
            </div>
          </div>
        </div>
        </div>
