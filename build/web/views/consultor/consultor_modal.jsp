                ...
                <div id="divFormSolicitud_up">
                    <div class="form-row">
                        <div class="form-group col-md-6">
                            <label for="id_idSolicitud_up">ID</label>
                            <input type="text" class="form-control" id="id_idSolicitud_up" name="id_idSolicitud_up" placeholder="ID" disabled style="color: red">
                        </div>
                    </div>
                    <div class="form-row">
                        <div class="form-group col-md-6">
                    ...
                    <div class="form-row">
                        <div class="form-group col-md-6">
                            ...
                            <input type="number" min="1" class="form-control" id="id_presupuesto_up" name="id_presupuesto_up" placeholder="Presupuesto">
                        </div>
                        <div class="form-group col-md-6">
