            ...
            <div id="divFormSolicitud">
                ...
                <div class="form-row">
                    ...
                    <div class="form-group col-md-6">
                        ...
                        <input type="number" class="form-control" id="id_cantidad" name="id_cantidad" placeholder="0">
                    </div>
                </div>
                ...
                <div class="form-row">
                    ...
                    <div class="form-group col-md-6">
                        ...
                        <input type="number" class="form-control" id="id_presupuesto" name="id_presupuesto" placeholder="0">
                    </div>
